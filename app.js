document.addEventListener('DOMContentLoaded', () => {
    ...
    async function saveLeadData(lead) {
        ...
        // 1. Recalculate Score before saving/rendering
        ...
        const payload = {
            ...
            // Boolean Statuses
            intro: lead.intro, // Added this so Intro Meeting saves too
            weekly: lead.weekly, // Added this so Weekly Calls saves too
    ...
    function normalizeLead(item, index) {
        ...
        const lead = {
            id: `lead-${index}`,
            customer: company, 
            logo: logoUrl, linkedin: linkedinUrl, slides: slidesUrl,
        ...
        dom.detailsPanel.innerHTML = `
            <div class="detail-card">
                ...
                <div class="status-toggles">
                    <div class="status-item clickable" onclick="window.toggleTopStatus('${lead.id}', 'intro')">
                        ${lead.intro ? checkIcon : xIcon} Intro Meeting
                    </div>
                    <div class="status-item clickable" onclick="window.toggleTopStatus('${lead.id}', 'weekly')">
                        ${lead.weekly ? checkIcon : xIcon} Weekly Calls
                    </div>
                </div>
    ...
    function setupGlobalFunctions() {
        ...
        // NEW: Toggle Intro/Weekly
        window.toggleTopStatus = (id, key) => {
